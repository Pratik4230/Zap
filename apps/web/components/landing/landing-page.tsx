...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-black">
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-100 focus:rounded-lg focus:bg-white focus:px-4 focus:py-2 focus:text-sm focus:font-medium focus:text-black"
      >
        Skip to content
      </a>
        ...
        <section className="border-y border-white/6 bg-neutral-950 px-6 py-20">
          <div className="mx-auto mb-12 max-w-3xl text-center">
            ...
            <p className="mt-3 text-muted-foreground">
              Three problems every link tool should solve. We focus on these and
              skip the rest.
            </p>
          </div>
          <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 lg:grid-cols-3">
            {HIGHLIGHTS.map(
              ({ icon: Icon, tag, title, hook, description, points }) => (
                <div
                  key={title}
                ...
                >
                  ...
                  <p className="mt-3 text-base leading-snug font-medium text-foreground/90">
                    {hook}
                  </p>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
                Every feature exists because a real link problem needed solving.
                No filler, no upsells for things we have not shipped.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
              {FEATURES.map(
                ({ icon: Icon, title, hook, description, points }) => (
                  <div
                    key={title}
        ...
        >
          ...
          >
            <div
              ...
              style={{
                background: `radial-gradient(ellipse, ${AMBER} 0%, transparent 70%)`,
              }}
            />
          </div>
          ...
          <div className="relative mx-auto max-w-5xl">
            <div className="mb-16 text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                No setup guide. No config files. Just paste, share, and watch.
              </p>
            </div>
        ...
        <section id="pricing" className="bg-black px-6 py-20">
          <div className="mx-auto max-w-6xl">
            <div className="mb-12 text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                Start free. Upgrade to Pro when you need more, billed via Dodo
                Payments.
              </p>
            </div>
            ...
            <p className="mt-8 text-center text-xs text-muted-foreground">
              All plans include edge-fast redirects, HTTPS, and real-time
              analytics. Prices in USD.
            </p>
          </div>
        </section>
