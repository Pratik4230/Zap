  ...
  return (
    ...
    >
      ...
      <Sheet>
        ...
        <SheetContent
          side="left"
          className="w-60 border-r border-white/6 p-0"
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2.5 rounded-lg px-2 py-1.5 transition-colors outline-none hover:bg-white/5">
            <Avatar className="h-7 w-7">
              <AvatarImage src={user?.image ?? ""} alt={user?.name ?? ""} />
              <AvatarFallback
                className="text-xs font-semibold"
                style={{
                  background: "oklch(0.769 0.188 70.08 / 20%)",
